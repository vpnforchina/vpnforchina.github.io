...
>**2021年3月更新信息**：目前PureVPN、VyprVPN、Ivacy、Surfshark在国内都基本上已经失效；Lantern蓝灯VPN经常出现连接失败的问题；NordVPN除了安卓手机能直连其他设备只能手动配置连接，要找客服获取中国专用客户端；光年VPN国内少数地区可能有连接不上、速度慢的问题，选择时请注意避坑。
