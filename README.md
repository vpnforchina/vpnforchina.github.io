...
我写这篇文章，是为了帮读者找到中国好用的翻墙软件，我只能尽我所能地测试，结合自己使用情况进行说明。因为翻墙软件能否有比较好的使用体验，除了取决于厂商、产品等因素外，还有无法预测的变量，比如上网时段、不同地区网络接入商当时的审查口径、用户自己的上网环境和设备等，比如有些香港节点，在广东连接传输速度很快，但在内陆省份可能速度就一般，不同时期受到墙的干扰也会不一样，所以请读者关注本文头部的“`最后修改于`“时间，我会一直尽可能地给大家最新、最准确的讯息。
